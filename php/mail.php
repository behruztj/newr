...
try {
  ...
  $mail->Username = 'boria.yusupov2017@yandex.ru'; // Логин на почте
  $mail->Password = 'otjqzvqmwkmixbkl'; // Пароль на почте
  $mail->SMTPSecure = 'ssl';
  $mail->Port = 465;

  $mail->setFrom('boria.yusupov2017@yandex.ru', 'Заявка с сайта'); // Адрес самой почты и имя отправителя

  // Получатель письма
  $mail->addAddress('boria.yusupov2017@yandex.ru');
